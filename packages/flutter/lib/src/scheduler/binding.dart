...
import 'package:flutter/ui.dart' show AppLifecycleState, VoidCallback;
...
///   [schedulingStrategy].
abstract class SchedulerBinding implements BindingBase, ServicesBinding {
  // This class is intended to be used as a mixin, and should not be
  // extended directly.
  factory SchedulerBinding._() => null;

  void initInstances_SchedulerBinding() {
    _instance = this;
  ...
  void initServiceExtensions_SchedulerBinding() {
  ...
  void unlocked_SchedulerBinding() {
