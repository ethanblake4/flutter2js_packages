...
abstract class GestureBinding
    implements BindingBase, HitTestable, HitTestDispatcher, HitTestTarget {
  // This class is intended to be used as a mixin, and should not be
  // extended directly.
  factory GestureBinding._() => null;

  void initInstances_GestureBinding() {
    _instance = this;
    ui.window.onPointerDataPacket = _handlePointerDataPacket;
  }

  void unlocked_GestureBinding() {
